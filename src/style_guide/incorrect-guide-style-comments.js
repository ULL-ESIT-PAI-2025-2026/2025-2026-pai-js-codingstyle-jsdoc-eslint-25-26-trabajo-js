...
function pow(x,n) //1. Missing space afetr comma, 7. Incorrect variable naming 
...
let x=prompt("x?",''), n=prompt("n?",'') // 3. no space arround '=' , 5. mutiple declarations in the same line, 7. Incorrect variable naming 
